...
- (void)productsRequest:(SKProductsRequest *)request didReceiveResponse:(SKProductsResponse *)response
{
    ...
    {
        model = [[PurchaseModel alloc] initWithName:@"AVAILABLE PRODUCTS" elements:response.products];
    ...
    {
        model = [[PurchaseModel alloc] initWithName:@"INVALID PRODUCT IDS" elements:response.invalidProductIdentifiers];
        [self.productRequestResponse addObject:model];
    }
